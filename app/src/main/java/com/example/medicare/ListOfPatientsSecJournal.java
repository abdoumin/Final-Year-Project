...
public class ListOfPatientsSecJournal extends AppCompatActivity {
    ...
    private void intiliaze() {
        ...
        GridLayoutManager gridLayoutManager = new GridLayoutManager(ListOfPatientsSecJournal.this,1);
        recycleView.setLayoutManager(gridLayoutManager);



        PatientsJournalAdapter myAdapter = new PatientsJournalAdapter(ListOfPatientsSecJournal.this,patientList);
